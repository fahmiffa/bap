<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 relative">
    ...
    <div x-show="open" @click="open = false"
        class="fixed inset-0 bg-black bg-opacity-50 z-40 transition-opacity duration-300" x-transition.opacity></div>

    <!-- Sidebar -->
    <div :class="{ 'translate-x-0': open, '-translate-x-full': !open }"
        class="fixed md:hidden top-0 left-0 h-screen w-64 bg-white shadow-2xl z-50 transform transition-transform duration-300">
